            ...
            <div className="row">
              ...
              <div className="row description-div">
                ...
                <p>
                  ...
                  <i>Be Here</i> comes in. On <i>Be Here</i>, you'll find events
                  by and for members of your organization's community. The
                  pickup soccer, book clubs, city tours, and other activities
                  you'll find here can be the magic that turns "friendly" into
                  "friendship".
                </p>
                ...
                <p>
                  When you sign up for <i>Be Here</i>, we ask for your
                  organization (company, school, etc.) email. You'll be
                  connected to other users who have emails at the same domain.
                  You can post events for everyone with emails at that domain to
                  find, and you'll be able to interact with posts by other uses
                  with emails at the same domain as yours.
                </p>
                <p>
                ...
                <p>
                  Your organization does not need to sign up for you to be able
                  to connect to other users with emails at the same domains as
                  yours.
                </p>
              </div>
